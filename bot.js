...
var botConfigs = {
    token: "NTgxNjM1NTkxNTg2OTcxNjY4.XOiJbw.DDaZ-c3yt5yq3paehxwwHmo0pn8",
    prefix: "R!",
    gameStatus: "Work in progress",
    ...
    ticketsystem: {
    "ticketCategoryID": "533780642895364097",
    "createTicketChannelID": "581641506364981251"
}
};
...
client.on("guildMemberAdd", async function(member) {
    if (botConfigs.plugins[1].activated == true) {
        member.guild.channels
            ...
            .send(`${botConfigs.welcomemessage.text}, ${member}`);
    }
});
